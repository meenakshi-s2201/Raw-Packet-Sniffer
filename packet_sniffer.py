...
#To help format output - indentation needed to to visually show protocol nesting levels (Ethernet → IPv4 → TCP/UDP → ..)
TAB_1 = '\t - '
TAB_2 = '\t\t - '
TAB_3 = '\t\t\t - '
TAB_4 = '\t\t\t\t - '
...
def ethernet_frame(data):
    ...
    return get_mac_address(dest_mac), get_mac_address(src_mac), socket.ntohs(protocol), data[14:]
